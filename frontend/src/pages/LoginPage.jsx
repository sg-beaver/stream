...
const NOTICES = [
  { id: 1, title: '[서강글로벌사회공헌원] “2026 세계경주포럼 x UIA 임팩톤@경주” 참가자 모집 (~9/6)', date: '2026.09.02' },
  { id: 2, title: '[미래교육원] 『블랜더3D모델링&애니메이션』 강좌 수강생 모집', date: '2026.09.02' },
  { id: 3, title: '[서강시스템반도체설계교육센터] SoC설계코어드라이브과정 모집 안내 (~9/30)', date: '2026.09.02' },
  { id: 4, title: '[예비군연대본부] 예비군 훈련 공고 (10/6)', date: '2026.09.02' },
  { id: 5, title: '[G-LAMP사업단] 서강대학교 G-LAMP 사업단 LAMP 포닥 채용 공고(~9/10)', date: '2026.09.01' },
]
...
export default function LoginPage() {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      setSessionUser({ id, name: res.name, role: res.role, token: res.token, department_id: res.department_id, department_name: res.department_name, major: res.major, is_team_lead: res.is_team_lead, course_ta_enabled: res.course_ta_enabled })
