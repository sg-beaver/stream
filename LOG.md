...
- **After**: 가능시간 180행·학기 489시간/방학 430시간(학생당 각 48.9h·43.0h), 수업 39건.
  - 학기 중 2주: **`FEASIBLE` / solve 30.04s(시간 제한 도달)** / 배정 57건 270시간 / 커버 312 / 미충원 0 / 학생별 26~40h
  - 방학 2주: `OPTIMAL` / solve **3.14s** / 배정 54건 252시간 / 커버 252 / 미충원 0 / 학생별 23~46h
